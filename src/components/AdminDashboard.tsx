            ...
            <div className="flex-1 overflow-y-auto p-5">
              <form id="product-form" onSubmit={handleSaveProduct} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="sm:col-span-2">
                    <label className="block text-xs font-bold text-slate-700 mb-1">Additional Image URLs (one per line)</label>
                    <textarea 
                      value={editingProduct.additional_images?.join('\n') || ''} 
                      onChange={e => setEditingProduct({...editingProduct, additional_images: e.target.value.split('\n')})} 
