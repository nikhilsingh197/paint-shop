          ...
          <div className="max-w-sm w-full mx-auto">
            ...
            <div className="flex bg-slate-100 p-1 rounded-xl mb-6">
              <button
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-colors ${authMethod === "phone" ? "bg-white text-slate-900 shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
              >
                Mobile Number
              </button>
              <button
                ...
                className={`flex-1 py-2 text-sm font-bold rounded-lg transition-colors ${authMethod === "email" ? "bg-white text-slate-900 shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
              >
                Email Address
              </button>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 outline-none text-sm text-slate-900 transition-all disabled:opacity-50"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 outline-none text-sm text-slate-900 transition-all text-center tracking-widest font-bold"
                        placeholder="123456"
                        maxLength={6}
                      />
                    </div>
